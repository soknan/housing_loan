<?php
Route::group(array('prefix' => 'loan', 'before' => 'auth.cpanel|package.cpanel'), function () {
...
// Repayment Schedule
    ...
    Route::get('dashboard/show/{id}', array(
    ...
    */
    ...
    Route::get('category/edit/{id}', array(
    ...
    Route::put('category/update/{id}', array(
        'as' => 'loan.category.update',
        'uses' => 'Battambang\Loan\CategoryController@update'
    ));
    Route::delete('category/destroy/{id}', array(
    ...
    */
    ...
    Route::put('staff/update/{id}', array(
        'as' => 'loan.staff.update',
        'uses' => 'Battambang\Loan\StaffController@update'
    ));
    Route::delete('staff/destroy/{id}', array(
