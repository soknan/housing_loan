...
class LookupValueController extends BaseController
{
    ...
    private function saveData($data)
    {
        ...
        $data->ln_lookup_id = Input::get('cp_lookup_id');
        $data->save();
    }

    public function getDatatable()
    {
        $item = array('id', 'code', 'name', 'ln_lookup_id');
        $data = DB::table('ln_lookup_value');
        ...
        return \Datatable::query($data)
            ->addColumn('action', function ($model) {
                ...
                return Action::make()
                    ...
                    ->delete(route('loan.lookup_value.destroy', $model->id), $model->id, false)
