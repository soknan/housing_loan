...
class RptLoanPrePaidDepositController extends BaseController
{
    public function index()
    {
        //$data['reportHistory'] = $this->_reportHistory();
        return $this->renderLayout(
            \View::make('battambang/loan::rpt_loan_prepaid_deposit.index')
        );
    }
    ...
    public function report()
    {
        ...
        $condition.= " AND ln_pre_paid.activated_at BETWEEN
                        ...
                        and ln_pre_paid.amount_pre_paid >0 ";
...
INNER JOIN ln_perform on ln_perform.ln_disburse_client_id =ln_pre_paid.ln_disburse_client_id and ln_perform.perform_type='disburse'
        ...
        ");
// User action
        \Event::fire('user_action.report', array('rpt_loan_prepaid_deposit'));
       ...
       //exit;
        ...
        \Report::setReportName('Loan_Pre-Paid Deposit')
            ->setDateFrom($data['date_from'])
        ->setDateTo($data['date_to']);
        return \Report::make('rpt_loan_prepaid_deposit/source', $data,'loan_prepaid_deposit');
